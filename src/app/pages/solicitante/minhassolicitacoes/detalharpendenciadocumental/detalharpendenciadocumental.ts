...
@Component({
  selector: 'app-detalharpendenciadocumental',
  imports: [RouterLink, Breadcrumb, CommonModule, FormsModule, Cabecalhosolicitacao],
  templateUrl: './detalharpendenciadocumental.html',
  styleUrl: './detalharpendenciadocumental.css'
})
export class Detalharpendenciadocumental implements AfterViewInit {
  pageBreadcrumbs = [
    { text: 'Home', address: '/solicitante/' },
    { text: 'Minhas solicitações', address: '/solicitante/minhassolicitacoes' },
    { text: 'Detalhamento de Pendência Documental', address: '' }
  ];
