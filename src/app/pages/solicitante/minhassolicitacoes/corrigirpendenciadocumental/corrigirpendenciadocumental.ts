...
@Component({
  selector: 'app-corrigirpendenciadocumental',
  imports: [RouterLink, Breadcrumb, CommonModule, FormsModule, Cabecalhosolicitacao],
  templateUrl: './corrigirpendenciadocumental.html',
  styleUrl: './corrigirpendenciadocumental.css'
})
export class Corrigirpendenciadocumental {
  pageBreadcrumbs = [
    { text: 'Home', address: '/solicitante/' },
    { text: 'Minhas solicitações', address: '/solicitante/minhassolicitacoes' },
    { text: 'Corrigir Pendência Documental', address: '' }
  ];
